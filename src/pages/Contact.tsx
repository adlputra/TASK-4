...
const ContactTopImage = () => {
  return (
    <div className="contact-section-top-image-wrapper">
      <img
        src="https://uploads-ssl.webflow.com/62b1938e4a11c675eaa9acff/62c47aad62bdd0864055b0c1_ayush_photo-removebg-preview%202.png"
        loading="lazy"
        srcSet="
          https://uploads-ssl.webflow.com/62b1938e4a11c675eaa9acff/62c47aad62bdd0864055b0c1_ayush_photo-removebg-preview%202-p-500.png 500w,
          https://uploads-ssl.webflow.com/62b1938e4a11c675eaa9acff/62c47aad62bdd0864055b0c1_ayush_photo-removebg-preview%202-p-800.png 800w,
          https://uploads-ssl.webflow.com/62b1938e4a11c675eaa9acff/62c47aad62bdd0864055b0c1_ayush_photo-removebg-preview%202.png 862w"
        width="297"
          ...
          >
            ...
            <div className="field-wrapper">
              ...
              <input
                ...
                name="Email"
                data-name="Email"
                placeholder="Barnwalayush11@gmail.com"
                id="Email"
...
const DetailsLinkWrapper = () => {
  return (
    <div className="details-link-wrapper">
      <a
        href={`mailto:Barnwalayush11@gmail.com`}
        className={`detail-link margin-bottom-6`}
      >
        Barnwalayush11@gmail.com
      </a>
      <br />
      <a href={`tel:+916201318516`} className={`detail-link`}>
        +91 6201318516
      </a>
    </div>
  );
...
const ContactSocialLinksWrapper = () => {
  return (
    <div className={`contact-social-links-wrapper`}>
      <a
        href={`https://www.linkedin.com/in/ayush-raj-25796a1b3/`}
        target="_blank"
      ...
      <br />
      <a
        href={`https://www.instagram.com/ayushrajishere/`}
        target="_blank"
        rel="noopener noreferrer"
        className={`detail-link`}
      >
      ...
      <br />
      <a
        href={`https://twitter.com/ayushrajhere`}
        target="_blank"
        rel="noopener noreferrer"
        className={`detail-link`}
      >
